...
- **Agent dispatch (AFK small/medium):** the filled template becomes the Agent prompt. Use worktree isolation. Results return in-session — skip the handoff file; still require the don't-merge PR.
...
- Open a PR titled "<type>(#<N>): <summary>", marked DO NOT MERGE. The PM hub merges, not you.

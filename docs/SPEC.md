...
|---|---|---|
| 2026-06-21 | **Capability Map published** (`docs/CAPABILITY_MAP.md`) — canonical 9-core + 2-enabling capability taxonomy from a grilling walk; supersedes the CONTEXT.md "Bounded Contexts" list. **Confirmation codes move into the Documents capability** (ADR-0016). Council review report at `docs/CAPABILITY_MAP_REVIEW.html`. | docs/CAPABILITY_MAP.md, ADR-0016 |
